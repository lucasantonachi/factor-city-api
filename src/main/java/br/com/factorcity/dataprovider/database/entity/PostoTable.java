...
public class PostoTable {
    ...
    public PostoTable(Long idPosto, String latitudePosto, String longitudePosto, Integer avaliacaoPosto, BigDecimal precoGasolina, BigDecimal precoEtanol, BigDecimal precoDiesel, BigDecimal precoGas) {
